...
function formatOpenedVia(type: string | undefined, source: string | undefined) {
  if (source === "linking") return "Opened via custom scheme deep link (Detour not involved)";
  if (type === "deferred") return "Opened via Detour handled deep link (deferred link)";
  if (type === "verified")
    ...
    <View style={styles.screen}>
      <View style={styles.card}>
        ...
        <Text style={styles.label}>
          {fromDeepLink ? formatOpenedVia(linkType, source) : "Opened via button navigation"}
        </Text>
        {fromDeepLink && (
          <>
