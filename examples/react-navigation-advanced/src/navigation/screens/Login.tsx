    ...
    <View style={styles.screen}>
      <View style={styles.card}>
        ...
        <Text style={styles.label}>
          This example protects <Text style={styles.bold}>Details</Text> and resumes pending deep
          links after sign in.
        </Text>
        <Text style={styles.instructions}>
          Try links resolving to <Text style={styles.bold}>/details</Text> (can include query
          parameters) while signed out. The app should keep a pending target and continue after
          login.
        </Text>
        <Text style={styles.instructions}>
        ...
        <Pressable accessibilityRole="button" onPress={login} style={styles.button}>
